    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ms-auto" id="navbarMenuRPL">
                ...
                <a class="nav-link hover-shadow dropdown" href="{{ url('tugas') }}">Jobs</a>
            ...
            <div class="row">
                <div class="col q">
                    <div class="left-side">
                        ...
                        <h2 class="item hover-shadow">Kelas</h2>
                        <form method="GET" action="{{ url('tugas') }}">
                        ...
                        <!-- <h2 class="item hover-shadow">Sub-Kategori</h2>
                        <form method="GET" action="{{ url('tugas') }}">
                        ...
                        <div class="buttonHolder mt-5">
                            <a class="btn first" href="{{ url('tugas/create') }}">Buat Jobs</a>
                            <a class="btn" href="{{ url('tugas?keywordOwner='.$model->name) }}">Jobs Saya</a>
                        </div>
                    </div>
                </div>
                <div class="col w">
                    ...
                    @if($datas->count() == 0)
                        <h2 class="judul mt-5">Sedang tidak ada pekerjaan nih ..</h2>
                    @else
                    <h1 class="judul">Cari Jobs</h1>
                    @endif
                            ...
                            <div class="isi">
                                ...
                                <div class="item-isi">
                                    ...
                                    <div class="item-info">
                                        ...
                                        <h4 class="right">Bayaran: {{ @money($value->harga) }}</h4>
                                    </div>
                                </div>
                            </div>
